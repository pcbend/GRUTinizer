...
public:
  ...
  // Conversion from scattering particle to recoil particle, or vice-versa
  double ConvertThetaLab(double theta_lab_a, int parta, int partb);
  ...
  TGraph *ThetaLabVsThetaLab(int parta, int partb);
