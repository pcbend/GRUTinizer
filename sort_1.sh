...
INPUTS="e15130.val e15130.cal zcuts_run110.cuts /home/gretinaadmin/Programs/GRUTinizer/lib/libMakee15130_v3.so -o/dev/null " 
...
for i in $FILES
do
  grutinizer -qH $i /home/gretinaadmin/Programs/GRUTinizer/lib/libMakee15130_v3.so e15130.val e15130.cal zcuts_run110.cuts -o /dev/null
done
