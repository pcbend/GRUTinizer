...
GCutG *incoming_p41=0;
GCutG *incoming_s42=0;
GCutG *incoming_si39=0;

GCutG *outgoing_p41=0;
GCutG *outgoing_s42=0;
GCutG *outgoing_si39=0;
...
void MakeHistograms(TRuntimeObjects& obj) {
  ...
  if(!incoming_p41) {
    incoming_p41 = (GCutG*)gates->FindObject("in41P");
  }
  if(!incoming_s42) {
    incoming_s42 = (GCutG*)gates->FindObject("in42S");
  }
  if(!incoming_si39) {
    incoming_si39 = (GCutG*)gates->FindObject("in39Si");
  }
  
  if(!outgoing_p41) {
    outgoing_p41 = (GCutG*)gates->FindObject("out41P");
  }
  if(!outgoing_s42) {
    outgoing_s42 = (GCutG*)gates->FindObject("out42S");
  }
  if(!outgoing_si39) {
    outgoing_si39 = (GCutG*)gates->FindObject("out39Si");
  }
  ...
  if(s800) {
    ...
    TriggerRegister(obj, incoming_p41, outgoing_p41);

    dirname = "S800";

    IncomingS800(obj, s800, 0);
    IncomingS800(obj, s800, incoming_p41);

    OutgoingS800(obj, s800, 0);
    OutgoingS800(obj, s800, outgoing_p41);

    DTA(obj, incoming_p41, outgoing_p41);


    TriggerRegister(obj, incoming_s42, outgoing_s42);

    IncomingS800(obj, s800, 0);
    IncomingS800(obj, s800, incoming_s42);

    OutgoingS800(obj, s800, 0);
    OutgoingS800(obj, s800, outgoing_s42);

    DTA(obj, incoming_s42, outgoing_s42);


    TriggerRegister(obj, incoming_si39, outgoing_si39);

    IncomingS800(obj, s800, 0);
    IncomingS800(obj, s800, incoming_si39);

    OutgoingS800(obj, s800, 0);
    OutgoingS800(obj, s800, outgoing_si39);

    DTA(obj, incoming_si39, outgoing_si39);
