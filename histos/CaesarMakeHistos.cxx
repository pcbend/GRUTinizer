...
void initializeKr88Cuts(TCutG* &pid_kr88, TCutG* &tcut_kr88, TCutG* &pid_rb, TCutG* &pid_br) {
...
void MakeHistograms(TRuntimeObjects& obj) {
  ...
  if(caesar) {
    ...
    initializeKr88Cuts(pid_kr88,tcut_kr88,pid_rb,pid_br);//cuts are global
        ...
        if (s800){
          ...
          if (pid_kr88->IsInside(objtac_corr, ic_sum)){
            ...
            if (tcut_kr88->IsInside(corr_time, energy_dc)){
              TH1 *caesar_energydc_kr88 = GetHistogram(list,"EnergyDC_Kr88_tcut", 512,0,8192);
