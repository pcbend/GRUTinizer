...
// Grutxx                                                               //
//                                                                      //
// X11 based routines used to display the splash screen for grutinize.  //
//                                                                      //
//                                                                      p
//////////////////////////////////////////////////////////////////////////
...
static void DrawVersion()
{
   ...
   char version[80];
   sprintf(version, "Version %s", GRUT_RELEASE);

   XDrawString(gDisplay, gLogoWindow, gGC, 15, gHeight-10, version,
               strlen(version));
}
...
static void DrawROOTCredit()
{
   ...
   XDrawString(gDisplay, gLogoWindow, gGC, 15, gHeight - 25, version,
               strlen(version));
}
